...
One question at a time. Walk the decision tree branch by branch, resolving dependencies in order. Offer a recommended answer with each question. If a fact is code-answerable, look it up instead of asking.
